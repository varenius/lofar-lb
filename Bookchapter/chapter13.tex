...
regarding, for example, the phase calibration using VLBI techniques. However, there are some
particular practical considerations that could help the observer to reduce an
International LOFAR observation. A detailed description of the particular
steps and software generally used to reduce these type of data can be found in
The LOFAR Imaging
Cookbook\footnote{\url{http://www.astron.nl/radio-observatory/lofar/lofar-imaging-cookbook}}.
Here we describe some of this
