...
def plugin_main(args, **kwargs):
    ...
    cdir = str(kwargs['dir']) # read in the current direction using tick information
    print('Sortmap running for cdir = '+cdir+', with mapfile_in = '+str(kwargs['mapfile_in']))
    ...
    (datamap , firstmap) = _sort_ObsSB(kwargs['mapfile_in'], int(kwargs['numSB']), filllNDPPPdummies=NDPPPfill, 
                                       ...
                                       truncateLastSBs=truncateLastSBs, cdir = cdir)
